...
public class JoinSessionViewHolder<TModelViewBinding extends ViewDataBinding> extends BaseBindableViewHolder<TModelViewBinding, SessionModel> {

    private ClickListener listener;

    public JoinSessionViewHolder(TModelViewBinding binding, int resourceId, ClickListener listener) {
