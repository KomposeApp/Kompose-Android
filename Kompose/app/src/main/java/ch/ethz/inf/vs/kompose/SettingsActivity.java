...
import ch.ethz.inf.vs.kompose.repository.KeysRepository;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int preload = sPrefs.getInt(KeysRepository.KEY_PRELOAD, 1);
        String username = sPrefs.getString(KeysRepository.KEY_USERNAME, "");
    ...
    public void confirmSettings(View v){
        ...
        editor.putInt(KeysRepository.KEY_PRELOAD, Integer.valueOf(preload_text));
        editor.putString(KeysRepository.KEY_USERNAME, username_text);
