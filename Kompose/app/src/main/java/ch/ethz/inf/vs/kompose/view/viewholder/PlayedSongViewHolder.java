...
public class PlayedSongViewHolder<TModelViewBinding extends ViewDataBinding> extends BaseBindableViewHolder<TModelViewBinding, SongModel> {

    private ClickListener listener;

    public PlayedSongViewHolder(TModelViewBinding binding, int resourceId, ClickListener listener) {
